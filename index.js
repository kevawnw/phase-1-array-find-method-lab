...
// function superbowlWin(arry) {
//     const win = arry.find(s => s.result === "W") 
//     if(win)
//         return win.year
    
// }

//Both function work but the second one invovle the use 
//of find()

function superbowlWin(arry, w) {
    const win = arry.find(s => s.result === w) 
    if(win)
        return win.year
...
console.log(superbowlWin(record, "W"))